...
public class Hilos {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Todos los hilos en estado " + multi[0].getState());
...
class Multiplicador extends Thread {
    ...
    @Override
    public void run() {
        System.out.println(Thread.currentThread().getName() + " entró a estado " + Thread.currentThread().getState() + "...");
